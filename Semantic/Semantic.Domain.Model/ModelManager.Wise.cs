                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            lock (this.syncObj)
                            {
                                ...
                                if (model.ParseType == Core.Parser.ParseType.TurtleModel)
                                {
                                ...
                                else if (model.ParseType == Core.Parser.ParseType.Antlr4Model)
                                {
                                    var complier = new Antlr4Complier();
                        ...
                        if (ModelManager.Instance().ParseModules.ContainsKey(module.FileId))
                        {
                            ModelManager.Instance().ParseModules[module.FileId] = module;
                        }
                        else
                        {
