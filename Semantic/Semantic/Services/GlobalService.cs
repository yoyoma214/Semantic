...
namespace CodeHelper.DataBaseHelper
{
    ...
    public static class ProjecctExtension
    {
        ...
        //public static Dictionary<string, TableType> GetTables(this ProjectType project,List<string> connections)
        //{
    ...
    //{
    //    public static ColumnType FindColumn(this TableType table, string field)
    //    {
    //        foreach (var f in table.ColumnSet.Columns)
    //        {
    //            if (f.Name == field)
    //                return f;
    //        }
