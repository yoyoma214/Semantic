...
namespace CodeHelper
{
    public partial class MainFrm : IReceiverHolder
    {
        ...
        void Init()
        {
            ...
            var cmdHost_owl = CommandHostManager.Instance().Get(CommandHostManager.HostType.OWL);
            cmdHost_owl.AddCommand(new OpenTurtleModelCommand(this.Receiver));
            ...
            cmdHost_owl.AddCommand(new OpenSwrlModelCommand(this.Receiver));
            cmdHost_owl.AddCommand(new NewSwrlModelCommand(this.Receiver));
            ...
            //CommandHostManager.Instance().AddCommand(CommandHostManager.HostType.OWL,
            //  new PropertySelectCommand(this.receiver));
