...
namespace CodeHelper.Items
{
    public static class NodeFactory
    {
        ...
        public static BaseNode Create(Dict.NodeType nodeType , string name = null, string text = null)
        {
            ...
            if (nodeType == Dict.NodeType.SourceDirectory)
                node = new TurtleDirectoryNode();
            ...
            if (nodeType == Dict.NodeType.Swrl)
                node = new SwrlDirectoryNode();
