...
{
    class SwrlFileNode : ModelNode
    {
        public SwrlFileNode()
            : base()
        {
            this.TreeNode.Name = this.TreeNode.Text = "Swrl文件";
        }
        ...
        private void Mnu_GenVisitJava(object sender, EventArgs args)
        {
            try
            {
                ...
                //var builder = new IndentStringBuilder();
                ////module.NameSpace = ns;
                //((SwrlModule)module).GenVisitJava(builder);
                //codeFrm.SetText(builder.ToString());
                //codeFrm.Show();
        ...
        public override void OnDoubleClick()
        {
            ...
            var cmd = cmdHost.GetCommand(Dict.Commands.OpenSwrlModel)
                as OpenSwrlModelCommand;

            cmd.File = this.FullName;

            cmdHost.RunCommand(Dict.Commands.OpenSwrlModel);
        ...
        {
            get { return Dict.Extenstions.Swrl_Extension; }
            set { }
        }
