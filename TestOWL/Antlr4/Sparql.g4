...
//Wise(SparqlContext context);Wise(context)
//Format(SparqlContext context ,IndentStringBuilder builder);Format(context ,builder)
//BuildQuery(SparqlContext context ,IndentStringBuilder builder);BuildQuery(context ,builder)
...
| ( constraint | var )  ;
   ...
   multiplicativeExpressionItem:
                                    '*' unaryExpression | DIVISION unaryExpression
                                ;
   unaryExpression   :     NEGATE primaryExpression 
...
| GROUP_CONCAT '(' DISTINCT? expression ( ';' SEPARATOR '=' String )? ')'  ;
   ...
   rDFLiteral   :   String ( LANGTAG | xsdIri)? ;
